...
def brackets(request):
    ...
    result_list = Contestant.objects.exclude(actual_elimination__exact=69).order_by('actual_elimination')
    ...
    dict = {'players':player_list,'brackets':bracket_dict,'results':result_list,'scores':score_dict,'cur_scores':cur_score_list}
